...
const CartProduct = ({ el }: { el: any }) => {
    return (
        <div className='flex gap-16 items-center flex-wrap md:flex-nowrap mb-5'>
            <img className="w-64" src={el.image} alt={el.title} />
            <div className='flex gap-4 flex-col items-center dark:border-b md:border-none pb-4 rounded justify-between'>
